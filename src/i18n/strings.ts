...
const strings: Record<Locale, Dict> = {
  tr: {
    ...
    'dsp.short.youtubeMusic': 'YouTube Music',
    'dsp.short.deezer': 'Deezer',
    'dsp.short.amazonMusic': 'Amazon Music',
    'dsp.short.tidal': 'Tidal',
    'dsp.more': 'Diğer platformlar',
